...
static const int LAST_POW_BLOCK = 21631;
...
static const int64_t MAX_MONEY = 7030000 * COIN;
...
static const uint256 hashGenesisBlock("0000093f3daa08a5181d5567ac1bd80d84003cc71455d0b47d9ceb893a99dfa9");
static const uint256 hashGenesisBlockTestNet("INDA SOURCE u can find Gimpcoin's dev ;)");
...
public:
    ...
    {
        // Gimpcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // Gimpcoin: get transaction coin age
...
public:
    ...
    // Gimpcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Gimpcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Gimpcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // Gimpcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Gimpcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Gimpcoin: block index flags
    enum  
    {
